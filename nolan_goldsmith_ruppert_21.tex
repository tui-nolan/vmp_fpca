...
and \citeA[Section~2]{wang16}. Much of this work mirrors the eigendecomposition approach to PCA, in that an eigenfuncion basis is obtained from a covariance surface. \citeA{yao05} focused on the case of sparsely observed functional data, and estimate
...
for Bayesian FPCA are introduced in Sections \ref{sec:fpca_gauss_lik_frag} and \ref{sec:mean_fpc_gauss_pen_frag}.
...
principal component basis functions and uncorrelated scores.
