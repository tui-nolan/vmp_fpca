...
\caption{
	...
	The box plots in \subref{subfig:bf_accs} are a summary of the integrated squared error values in \eqref{ise}
	...
	principal component eigenfunctions \eqref{bf_gauss_sim} in black. For the case where $n = 500$, we show
	...
	for $n = 100$ in blue. Note that, in each panel,
...
The box plots for the integrated squared error values
...
posterior mean curves for the case where $n = 500$
...
than the median MCMC simulation for $n = 10$, 39.5 times faster for $n = 50$, 46.9 times faster for $n = 100$,
