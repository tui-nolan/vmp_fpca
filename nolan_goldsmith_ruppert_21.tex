...
In FPCA, we often rely on nonparametric regression to ensure that eigenfunctions are smooth and employ
an appropriate step to ensure that the basis functions are orthonormal from the perspective of integration, rather
...
principal component scores through conditional expectations. \citeA{xiao2016} developed a fast covariance estimation method for densely observed functional data. \citeA{di09} extended FPCA to multilevel functional data, extracting within and
