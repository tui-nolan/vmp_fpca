...
From equation (10) of \citeA{wand17}, we deduce that the natural parameter vector for $q (\bnu)$ is
...
According to Result 6 of \citeA{maestrini20},
...
\noindent According to equation (8) of \citeA{wand17}, the message from the factor $p (\by | \bnu,
...
\noindent According to equation (8) of \citeA{wand17}, the message from the factor
...
\noindent According to equation (8) of \citeA{wand17}, the message from $p (\by | \bnu,
...
parameter vectors are essential for determining expectations with respect to the optimal posterior distribution.
According to equation (10) of \citeA{wand17}, the natural parameter vector for $q (\bnu)$ is
...
$\npq{\sigsqmu}$. According to Result 6 of \citeA{maestrini20},
...
\noindent According to equation (8) of \citeA{wand17}, the message from the factor $p(\bnu | \sigsqmu, \sigsqpsi{1}, \dots, \sigsqpsi{L})$
to $\bnu$ is
...
\noindent According to equation (8) of \citeA{wand17}, the message from the factor $p(\bnu | \sigsqmu, \sigsqpsi{1}, \dots,
